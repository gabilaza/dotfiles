...
"Compile
autocmd filetype python nnoremap <leader>c :w! <bar> exec 'silent !clear' <bar> :redraw! <bar> exec '!python '.shellescape('%')<CR>
...
autocmd filetype rust nnoremap <leader>c :w! <bar> exec 'silent !clear' <bar> :redraw! <bar> exec '!rustc '.shellescape('%').' && time ./'.shellescape('%:r')<CR>

"Compile graphics with SFML
...
" django
"autocmd filetype python,html,css,javascript nnoremap <leader>r :w! <bar> exec 'silent !clear' <bar> :redraw! <bar> exec '!python ./manage.py runserver'<CR>
